...
import outlookCalendarLogo from "@/assets/outlook-calendar.svg";
...
export const IntegrationLogos: Record<IntegrationAppEnum, string | string[]> = {
...
export type IntegreationTitleType =
  | "Google Meet & Calendar"
  | "Zoom Meeting"
  | "Microsoft Teams"
  | "Outlook Calendar";

export const IntegrationDescription: Record<IntegrationAppType, string> = {
  GOOGLE_MEET_AND_CALENDAR:
